...
public class QaldEvaluatorApplication {
    ...
    public void csvToOutput() throws IOException {
        File csvOutputFile = new File("../../eval-results/19_Stanford-NER-AGDISTIS-NED_Earl_SINA.csv");
    ...
    public static void main(String... args) throws UnsupportedEncodingException, IOException {
        ...
        componentConfigurations.add("NER-Stanford,NED-AGDISTIS,EarlRelationLinking,SINA");
